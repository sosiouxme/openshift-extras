...
GEM_PATH=$GEMPATH RUBYLIB=$RUBYLIB OO_INSTALL_CONTEXT=INSTALLCONTEXT OO_VERSION='OPENSHIFTVERSION' OO_INSTALL_VERSION='INSTALLVERSION' sh -c "ruby ${TMPDIR}INSTALLPKGNAME/bin/oo-install ${cmdlnargs}"
